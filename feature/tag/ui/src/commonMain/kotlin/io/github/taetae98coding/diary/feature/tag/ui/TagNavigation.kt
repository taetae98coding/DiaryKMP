...
internal fun List<ScreenNavKey>.tagDetailScaffoldComponentVisible(
    key: TagDetailNavKey,
    isListPaneVisible: Boolean,
): TagDetailScaffoldComponentVisible = TagDetailScaffoldComponentVisible(isNavigateUpButtonVisible = !isListPaneVisible || isNavigatedFromTagDetail(key))
