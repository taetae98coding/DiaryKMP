...
class ContactDetailMemoRefreshTest {
    @get:Rule
    ...
    fun `TC-SYNC-REFRESH-FEATURE-001 목록을 당기면 새로고침을 요청한다`() {
        ...
        setMemoTab(
            pagingData = contactMemoPagingData(itemList = listOf(MemoListItem.Content(memo = contactMemo(title = MEMO_TITLE)))),
    ...
    private companion object {
        const val MEMO_TITLE = "ContactMemoRefreshTitle"
