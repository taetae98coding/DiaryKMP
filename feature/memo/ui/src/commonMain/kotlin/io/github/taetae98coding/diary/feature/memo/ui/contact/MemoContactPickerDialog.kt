...
internal fun MemoContactPickerDialog(
    ...
    DiaryPickerDialog(
        ...
        val isSearchEmpty by remember(searchFieldState, contactPagingItems) {
            derivedStateOf { searchFieldState.textFieldState.text.isNotBlank() && contactPagingItems.isLoadedEmpty() }
        }
