...
internal fun MemoAddScreen(
    ...
    MemoAddEnterEffect(tagAddRequestKey = tagAddRequestKey, scaffoldState = scaffoldState, addViewModel = addViewModel, tagViewModel = tagViewModel, webViewModel = webViewModel, placeViewModel = placeViewModel, placeMapViewModel = placeMapViewModel, geminiViewModel = geminiViewModel)

    MemoAddScaffold(
        state = scaffoldState,
        tagPagingItems = tagPagingItems,
        uiStateProvider = { uiState },
        onEvent = { event -> handleMemoAddEvent(event = event, addViewModel = addViewModel, tagViewModel = tagViewModel, webViewModel = webViewModel, placeViewModel = placeViewModel, geminiViewModel = geminiViewModel, scaffoldState = scaffoldState, navigateUp = navigateUp) },
        onFormEvent = { event ->
            handleMemoFormEvent(
                event = event,
                state = scaffoldState,
