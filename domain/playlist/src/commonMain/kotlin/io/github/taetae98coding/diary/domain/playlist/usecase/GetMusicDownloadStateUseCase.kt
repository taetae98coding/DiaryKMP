...
) : FlowUseCase<Unit, Map<Uuid, MusicDownloadState>>() {
    override fun execute(parameter: Unit): Flow<Result<Map<Uuid, MusicDownloadState>>> = musicDownloadManager.stateMap.map { stateMap -> Result.success(stateMap) }
}
