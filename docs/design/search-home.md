...
기준 스펙: [SearchHome 화면 스펙](../spec/client/search-home.md), [목록 빈 상태 스펙](../spec/client/list-empty-state.md), [페이지 조회 목록의 자리 표시 스펙](../spec/client/paged-list-placeholder.md)
