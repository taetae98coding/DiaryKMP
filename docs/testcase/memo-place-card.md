...
### TC-MEMO-PLACE-CARD-DOMAIN-020: 장소 추가로 이동할 때 카드의 지도가 보고 있던 위치를 넘긴다
...
### TC-MEMO-PLACE-CARD-DOMAIN-021: 지도가 표시되지 않으면 지도 위치를 넘기지 않는다
...
### TC-MEMO-PLACE-CARD-DOMAIN-022: 장소 추가로 이동할 때 보고 있던 지도 제공자는 넘기지 않는다
...
### TC-MEMO-PLACE-CARD-DOMAIN-023: 돌아온 뒤 다시 장소 추가로 이동하면 그때 보고 있던 위치를 새로 넘긴다
