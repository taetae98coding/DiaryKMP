...
### TC-MEMO-TAG-INPUT-DOMAIN-022: 메모리 정리 뒤 복원하면 검색어가 다시 나타나고 기다리지 않고 그 검색어로 좁힌 목록을 보여 준다
...
### TC-MEMO-TAG-INPUT-DATA-003: 태그 선택 목록을 나누어 조회한다
