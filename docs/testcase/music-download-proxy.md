...
### TC-MUSIC-DOWNLOAD-PROXY-DOMAIN-001: 주소 후보는 이 기기의 IPv4 사설 주소마다 하나씩이다
...
- 근거: `domain > 프록시 주소`
- Given: 이 기기에 IPv4 사설 주소가 하나 있는 상태로 프록시가 시작되어 제공 중이다.
- When: 이 기기가 다른 IPv4 사설 주소를 갖는 네트워크로 옮겨 간 뒤 프록시 주소 후보를 다시 확인한다.
