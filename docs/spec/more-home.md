...
사용자 정보 다시 확인은 인증 제공자에 현재 로그인 세션의 사용자 정보를 다시 요청해 저장된 사용자 정보를 그 결과로 바꾼다. 저장된 사용자 정보가 바뀌면 계정 상태가 다시 결정되는 규칙은 [계정 조회 스펙](./account.md)의 `domain > 계정 정보 변화 반영`을 따른다.
