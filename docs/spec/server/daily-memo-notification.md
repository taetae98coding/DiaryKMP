...
서버는 한국어와 영어 문구를 제공한다. 등록된 언어가 한국어이면 한국어로, 그 밖의 언어이면 영어로 만든다. 한국어는 언어 부분이 `ko`인 언어 태그다. 예: `ko`, `ko-KR`. 문구 자체는 [일일 메모 알림 디자인](../../design/daily-memo-notification.md)이 소유한다.
