...
- 모델 식별자: 그 모델로 생성을 요청할 때 사용하는 값이며 모델마다 다르다.
...
flowchart TD
    ...
    Filter --> Result["남은 모델 목록 전달<br/>(비어 있어도 성공)"]
...
- [Gemini API models.list](https://ai.google.dev/api/models)
- [Gemini API 모델](https://ai.google.dev/gemini-api/docs/models)
