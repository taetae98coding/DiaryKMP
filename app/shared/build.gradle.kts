    ...
    sourceSets {
        commonMain {
            dependencies {
                ...
                implementation(projects.core.calendarDatabase.impl)
                implementation(projects.core.calendarNetwork.impl)
                ...
                implementation(projects.core.integrity.impl)
