package io.github.taetae98coding.diary.core.database.impl.web.entity
...
@Entity(
    tableName = "account_web",
    primaryKeys = ["account_id", "web_id"],
)
internal data class AccountWebLocalEntity(
