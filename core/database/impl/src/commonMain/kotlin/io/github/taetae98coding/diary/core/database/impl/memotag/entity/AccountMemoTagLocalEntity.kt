package io.github.taetae98coding.diary.core.database.impl.memotag.entity
...
@Entity(
    tableName = "account_memo_tag",
    primaryKeys = ["account_id", "memo_id", "tag_id"],
)
internal data class AccountMemoTagLocalEntity(
