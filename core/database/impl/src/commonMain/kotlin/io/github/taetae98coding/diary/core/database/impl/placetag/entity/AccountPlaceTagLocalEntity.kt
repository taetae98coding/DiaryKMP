package io.github.taetae98coding.diary.core.database.impl.placetag.entity
...
@Entity(
    tableName = "account_place_tag",
    primaryKeys = ["account_id", "place_id", "tag_id"],
)
internal data class AccountPlaceTagLocalEntity(
