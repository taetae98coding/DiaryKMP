...
import io.github.taetae98coding.diary.core.database.impl.datasource.AccountTagSyncLocalDataSourceImpl
...
class AccountTagSyncTransactionImplTest :
    FunSpec({
        ...
        test("TC-DATA-SYNC-DOMAIN-009 현재 계정의 업로드 대기 태그를 조회하고 완료 태그는 제외한다") {
