package io.github.taetae98coding.diary.core.database.api.memocontact.entity
...
@Entity(
    tableName = "memo_contact",
    primaryKeys = ["memo_id", "contact_id"],
    indices = [Index(value = ["contact_id"])],
)
public data class MemoContactLocalEntity(
